...
const EditProfile = ({
  ...
  return visible ? (
    <form
      ...
      className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11 max-w-[800px]"
    >
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white items-center">
        Edit Profile Info
      </h3>
      ...
      <div>
        ...
        <input
          type="number"
          name="age"
          value={user.age ? user.age : 0}
          onChange={e => updateUser({ ...user, age: e.target.value })}
        ...
        <div className="flex flex-row justify-center items-center gap-4">
          <input
            type="submit"
            value="Submit"
            className={`mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark ${loading ? 'cursor-wait' : ''}`}
          />
          <button
            onClick={toggle}
            className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-red-800 px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-red-800/90 dark:shadow-submit-dark"
          >
            Cancel{' '}
          </button>
        </div>
